...
class Dice(RecourseMethod):
    ...
    def __init__(self, mlmodel: MLModel, hyperparams: Optional[Dict] = None) -> None:
        ...
        print("DICE - Initialized dice data and model")
        print(mlmodel.data.df.head())
    ...
    def get_counterfactuals(self, factuals: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            print(f"Error occurred while generating counterfactuals: {e}")
            return factuals, [time.perf_counter() - start_time] * len(factuals)
        ...
        list_times = [end_time - start_time] * len(df_cfs)
